...
BOOLEAN NTAPI  NtUserMoveWindow(HWND,int,int,int,int,BOOLEAN);
...
BOOLEAN NTAPI  NtUserRedrawWindow(HWND,RECT*,HANDLE,UINT);
...
HWND NTAPI     NtUserSetCapture(HWND);
...
BOOLEAN NTAPI  NtUserSetLogonNotifyWindow(HWND);
...
BOOLEAN NTAPI  NtUserShowWindow(HWND,INT);
